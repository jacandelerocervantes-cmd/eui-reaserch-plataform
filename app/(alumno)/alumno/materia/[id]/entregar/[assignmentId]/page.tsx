...
function EntregarContent({
  ...
  return (
    ...
    {/* Piloto ai-tutor-sandbox: ayuda mientras el alumno resuelve ESTA
        actividad puntual — ver supabase/functions/ai-tutor-sandbox.
        El backend decide si está habilitado para esta materia; el widget
        se muestra siempre y explica el estado si no lo está. */}
    <div className="fixed bottom-6 right-6 z-50">
      <AiTutorChat courseId={courseId} contextType="assignment" assignmentId={assignmentId} title="Tutor de esta actividad" />
    </div>
    </>
  );
}
