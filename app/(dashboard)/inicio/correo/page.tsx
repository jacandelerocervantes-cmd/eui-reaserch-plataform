...
import { 
  Sparkles, Send, Loader2, AlertCircle, Zap, ShieldCheck
} from "lucide-react";
              ...
              <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
                ...
                <div>
                  <div style={{ fontWeight: "800", color: "#1B396A", display: "flex", alignItems: "center", gap: "6px" }}>
                    {selectedMail.from}
                    {selectedMail.priority && selectedMail.priority <= 2 && <span title="Alta Prioridad" style={{ display: "flex" }}><AlertCircle size={14} color="#ef4444" /></span>}
                  </div>
