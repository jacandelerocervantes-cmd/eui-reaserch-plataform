...
import { useProyectoDetalleContent } from "../_hooks/useProyectoDetalle";
...
export default function DetalleProyectoContent({
  proyectoId, reloadKey, onReload,
}: { proyectoId: string; reloadKey: number; onReload: () => void }) {
  const c = useProyectoDetalleContent(proyectoId, reloadKey, onReload);
