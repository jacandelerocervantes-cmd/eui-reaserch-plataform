...
export default function PaseDeLista() {
  ...
  return (
    <div style={{ padding: "40px", maxWidth: "1000px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "30px", position: "relative" }}>
      ...
      {a.feedback && (
        <div style={{
          backgroundColor: a.feedback.type === "success" ? "#dcfce7" : "#fee2e2",
          border: `1px solid ${a.feedback.type === "success" ? "#bbf7d0" : "#fecaca"}`,
          color: a.feedback.type === "success" ? "#166534" : "#991b1b",
          padding: "12px 16px", borderRadius: "12px", fontWeight: "600", fontSize: "0.9rem",
          display: "flex", justifyContent: "space-between", alignItems: "center",
        }}>
          {a.feedback.message}
          <button onClick={() => a.setFeedback(null)} style={{ background: "none", border: "none", cursor: "pointer", color: "inherit", lineHeight: 0 }}><X size={16} /></button>
        </div>
      )}
