    ...
    <div style={{ marginBottom: "24px", backgroundColor: "white", borderRadius: "16px", border: "1px solid #e2e8f0", overflow: "hidden", boxShadow: "0 2px 4px rgba(0,0,0,0.02)" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <div style={{ backgroundColor: selectedStudentIds.length > 0 ? "#eef2f8" : "#f1f5f9", color: selectedStudentIds.length > 0 ? "#1B396A" : "#64748b", padding: "6px", borderRadius: "8px" }}>
            <UserCheck size={18} />
          </div>
          <div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          {selectedStudentIds.length > 0 && (
            <span style={{ fontSize: "0.75rem", fontWeight: "700", backgroundColor: "#1B396A", color: "white", padding: "3px 8px", borderRadius: "6px" }}>
        ...
        <div style={{ maxHeight: "340px", overflowY: "auto" }}>
          {loading ? (
            ...
            filteredStudents.map(s => {
              ...
              return (
                <label key={s.id} onClick={() => toggleStudentSelection(s.id)} style={{ display: "flex", alignItems: "center", gap: "12px", padding: "12px 20px", borderBottom: "1px solid #f1f5f9", cursor: "pointer", backgroundColor: isSelected ? "#eef2f8" : "white" }}>
