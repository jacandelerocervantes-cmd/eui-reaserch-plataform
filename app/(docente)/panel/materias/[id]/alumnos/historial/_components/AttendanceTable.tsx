      ...
      <table style={{ width: "100%", borderCollapse: "separate", borderSpacing: 0 }}>
        <thead style={{ position: "sticky", top: 0, zIndex: 10 }}>
          <tr style={{ backgroundColor: "#f8fafc" }}>
            ...
            <th style={{ padding: "12px 20px", borderBottom: "2px solid #e2e8f0" }}>% Asistencia</th>
          </tr>
        </thead>
        <tbody>
            ...
            return (
              <tr key={al.id} style={{ borderBottom: "1px solid #f1f5f9" }}>
                ...
                {uniqueDates.map((d, i) => {
                  ...
                  return (
                    <td key={i} style={{ textAlign: "center", padding: "5px" }}>
                      <button
                        onClick={openModal}
                        title={r ? "Editar asistencia" : "Agregar asistencia"}
                        style={{ background: "none", border: "none", borderRadius: "6px", padding: "6px", cursor: "pointer", opacity: r ? 1 : 0.25, transition: "background-color 0.15s" }}
                ...
                <td style={{ textAlign: "center" }}>
                  <span style={{ padding: "3px 10px", borderRadius: "10px", fontSize: "0.78rem", fontWeight: "bold", backgroundColor: pct >= 80 ? "#dcfce7" : "#fee2e2", color: pct >= 80 ? "#166534" : "#991b1b" }}>
                    {Math.round(pct)}%
                  </span>
                </td>
              </tr>
