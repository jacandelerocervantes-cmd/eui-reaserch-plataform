...
import { Check, X, AlertTriangle, Paperclip, Loader2, AlertCircle, FileText } from "lucide-react";
      ...
      <div style={{ backgroundColor: "white", padding: "28px 30px 30px", borderRadius: "20px", width: "420px", boxShadow: "0 25px 50px rgba(0,0,0,0.2)" }}>
        ...
        <div style={{ marginTop: "14px" }}>
          ...
          <div
            ...
            style={{
              border: "1.5px dashed #cbd5e1", borderRadius: "10px", padding: "12px",
              display: "flex", alignItems: "center", gap: "8px", cursor: "pointer",
              backgroundColor: fileToUpload ? "#f0f7ff" : "#f8fafc", transition: "all 0.2s",
            }}
          >
            <FileText size={18} color="#94a3b8" />
            <span style={{ fontSize: "0.82rem", color: "#475569", fontWeight: 600 }}>
              {fileToUpload ? fileToUpload.name : "Seleccionar archivo (PDF, JPG o PNG)"}
            </span>
          </div>
          {fileError && (
