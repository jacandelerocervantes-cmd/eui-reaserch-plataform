      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: "16px" }}>
        <div>
          ...
          <h1 style={{ color: "#1B396A", fontSize: "2rem", fontWeight: "800", margin: "0 0 8px 0", display: "flex", alignItems: "center", gap: "10px" }}>
            {selectedUnit.is_closed && <Lock size={24} color="#f59e0b" />} Captura de Calificaciones: {selectedUnit.name}
          </h1>
          <div style={{ display: "flex", gap: "16px", alignItems: "center", flexWrap: "wrap" }}>
            <span style={{ fontSize: "0.85rem", color: "#1e40af", backgroundColor: "#eff6ff", padding: "4px 10px", borderRadius: "8px", fontWeight: "700" }}>
              🎓 Asistencia: {assistWeight}%
            </span>
            <span style={{ fontSize: "0.85rem", color: "#15803d", backgroundColor: "#f0fdf4", padding: "4px 10px", borderRadius: "8px", fontWeight: "700" }}>
              📝 Actividades: {activWeight}% ({unitAssignments.length} tareas)
            </span>
            <span style={{ fontSize: "0.85rem", color: "#b45309", backgroundColor: "#fef3c7", padding: "4px 10px", borderRadius: "8px", fontWeight: "700" }}>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", minWidth: "900px" }}>
          <thead>
            ...
            <tr style={{ backgroundColor: "#f8fafc", borderBottom: "1px solid #cbd5e1" }}>
              ...
              <th style={{ padding: "12px 16px", textAlign: "center", color: "#1B396A", backgroundColor: "#f1f5f9", borderRight: "2px solid #cbd5e1", fontSize: "0.85rem", fontWeight: "800" }}>
                🎓 ASISTENCIA ({assistWeight}%)
              </th>
              ...
              {unitAssignments.length > 0 ? (
                unitAssignments.map(asg => {
                  ...
                  return (
                    <th key={asg.id} style={{ padding: "12px 14px", textAlign: "center", color: "#1e40af", backgroundColor: "#eff6ff", borderRight: "1px solid #bfdbfe", fontSize: "0.8rem" }}>
                      <div style={{ fontWeight: "700" }}>{asg.title}</div>
                      <div style={{ color: "#3b82f6", fontSize: "0.75rem", fontWeight: "800" }}>Vale {asgW.toFixed(1)}%</div>
                    </th>
                  );
                })
              ) : (
                <th style={{ padding: "12px 14px", textAlign: "center", color: "#1e40af", backgroundColor: "#eff6ff", borderRight: "2px solid #cbd5e1", fontSize: "0.85rem", fontWeight: "800" }}>
                  📝 ACTIVIDADES ({activWeight}%)
                </th>
              )}
              ...
              {unitExams.length > 0 ? (
                unitExams.map(ex => {
                  ...
                  return (
                    <th key={ex.id} style={{ padding: "12px 14px", textAlign: "center", color: "#92400e", backgroundColor: "#fffbeb", borderRight: "1px solid #fde68a", fontSize: "0.8rem" }}>
                      <div style={{ fontWeight: "700" }}>{ex.title}</div>
                      <div style={{ color: "#d97706", fontSize: "0.75rem", fontWeight: "800" }}>Vale {exW.toFixed(1)}%</div>
                    </th>
                  );
                })
              ) : (
                <th style={{ padding: "12px 14px", textAlign: "center", color: "#92400e", backgroundColor: "#fffbeb", borderRight: "2px solid #cbd5e1", fontSize: "0.85rem", fontWeight: "800" }}>
                  📋 EVALUACIONES ({evalWeight}%)
                </th>
              )}

              <th style={{ padding: "14px 16px", color: "#1B396A", fontSize: "0.9rem", textAlign: "center", backgroundColor: "#f8fafc", fontWeight: "900" }}>
                TOTAL UNIDAD (100%)
              </th>
            </tr>
          </thead>
              ...
              students.map(s => {
                ...
                return (
                  <tr key={s.id} style={{ borderBottom: "1px solid #f1f5f9" }}>
                    ...
                    {/* Input Asistencia */}
                    <td style={{ padding: "10px 14px", textAlign: "center", borderRight: "2px solid #cbd5e1", backgroundColor: "#fafafa" }}>
                      <input
                    ...
                    {unitAssignments.length > 0 ? (
                      unitAssignments.map(asg => {
                        ...
                        return (
                          <td key={asg.id} style={{ padding: "10px 12px", textAlign: "center", borderRight: "1px solid #e2e8f0", backgroundColor: "#f8fafc" }}>
                            <input
                              ...
                              style={inputStyle(selectedUnit.is_closed)}
                            />
                            <div style={{ fontSize: "0.7rem", color: "#3b82f6", marginTop: "2px", fontWeight: "600" }}>
                              +{pts.toFixed(1)} pts
                            </div>
                          </td>
                        );
                      ...
                      <td style={{ padding: "10px 14px", textAlign: "center", borderRight: "2px solid #cbd5e1", backgroundColor: "#f8fafc" }}>
                        <input
                          type="number" min="0" max="100"
                    ...
                    {unitExams.length > 0 ? (
                      unitExams.map(ex => {
                        ...
                        return (
                          <td key={ex.id} style={{ padding: "10px 12px", textAlign: "center", borderRight: "1px solid #e2e8f0", backgroundColor: "#fffdfa" }}>
                            <input
                              type="number" min="0" max="100" placeholder="0"
                              value={grades[key] !== undefined ? grades[key] : ""}
                              onChange={(e) => setGrades({ ...grades, [key]: e.target.value })}
                              ...
                              style={inputStyle(selectedUnit.is_closed)}
                            />
                            <div style={{ fontSize: "0.7rem", color: "#d97706", marginTop: "2px", fontWeight: "600" }}>
                              +{pts.toFixed(1)} pts
                            </div>
                          </td>
                        );
                      ...
                      <td style={{ padding: "10px 14px", textAlign: "center", borderRight: "2px solid #cbd5e1", backgroundColor: "#fffdfa" }}>
                        <input
                          type="number" min="0" max="100"
                    ...
                    {/* Total Unidad */}
                    <td style={{ padding: "12px 16px", textAlign: "center", backgroundColor: totalUnidad >= 70 ? "#f0fdf4" : "#fef2f2" }}>
                      <span style={{ fontWeight: "900", fontSize: "1.15rem", color: totalUnidad >= 70 ? "#15803d" : "#b91c1c" }}>
