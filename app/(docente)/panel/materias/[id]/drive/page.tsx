...
function DriveContent({ courseId, reloadKey, onRetry }: { courseId: string; reloadKey: number; onRetry: () => void }) {
  ...
  const {
    ...
    handleFileSelected,
    handleDelete,
  } = useDriveMateriaContent(courseId, reloadKey);
...
export default function DrivePage() {
  ...
  const { reloadKey, onReload } = useDriveMateria(courseId);

  return (
    <DriveContent courseId={courseId} reloadKey={reloadKey} onRetry={onReload} />
  );
}
