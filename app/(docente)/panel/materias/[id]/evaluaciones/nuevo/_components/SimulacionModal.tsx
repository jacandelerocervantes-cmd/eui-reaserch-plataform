            ...
            return (
              <button
                ...
                style={{
                  ...
                  backgroundColor: isSelected ? "#1B396A15" : "white",
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "6px",
                  padding: "4px 8px",
                  backgroundColor: i === 0 ? "#f8fafc" : "#1B396A15",
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "6px",
                  padding: "4px 8px",
                  backgroundColor: i === order.length - 1 ? "#f8fafc" : "#1B396A15",
                ...
                {questions.map((q, qIdx) => (
                  ...
                  >
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
                      ...
                      <span style={{ fontSize: "0.85rem", fontWeight: "800", color: "#1B396A", backgroundColor: "#1B396A15", padding: "4px 10px", borderRadius: "8px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                ...
                >
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
                    ...
                    <span style={{ fontSize: "0.9rem", fontWeight: "800", color: "#1B396A", backgroundColor: "#1B396A15", padding: "6px 12px", borderRadius: "8px" }}>
