...
const HIGH_RISK_OUTPUT_PATTERNS: Array<{ label: string; re: RegExp }> = [
  ...
  // ai-tutor-sandbox (piloto alumno): fingerprint del prompt socrático — ver
  // SOCRATIC_BASE_PROMPT en supabase/functions/ai-tutor-sandbox/index.ts.
  { label: "fuga_prompt_sistema", re: /REGLAS NO NEGOCIABLES|tutor socr[aá]tico del TecNM/i },
